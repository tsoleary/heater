...
Can I use this meta data to now annotate the dat_5 and dat_10 subsample clusters?
...
# 16,
ref_sce <- as.SingleCellExperiment(DietSeurat(subset(dat, NNv1_age > 7 & NNv1_age < 8)))
...
Is there a way to do this within the Seurat workflow instead of converting briefly to the SingleCellExperiment object class?
...
#
# # This took ~ 1 hr to run so saved this as an annot file to load later
...
markers <- FindConservedMarkers(dat_comb,
                                ident.1 = 6, # looking for differences in cluster 6 only
                                grouping.var = "time",
                                verbose = FALSE)
```
