...
# Save two sizes
ggsave("pheno/figures/cantonS_survival.tiff", height = 4, width = 6)
ggsave("pheno/figures/cantonS_survival_small.tiff", height = 3.5, width = 5)
```
...
# Save figure
ggsave("pheno/figures/na_genotypes_survival.tiff", height = 6, width = 10)
```
...
# Save figure
ggsave("pheno/figures/new_genotypes_survival.tiff", height = 6, width = 8)
```
...
# Save figure
ggsave("pheno/figures/new_genotypes_egg_to_pupa.tiff", height = 6, width = 8)
```
...
# Save figure
ggsave("pheno/figures/new_genotypes_egg_to_adult.tiff", height = 6, width = 8)
```
...
# Save figure
ggsave("pheno/figures/new_genotypes_pupation_height.tiff", height = 6, width = 8)
```
...
# Save figure
ggsave("pheno/figures/new_genotypes_walking_speed.tiff", height = 6, width = 8)
```
