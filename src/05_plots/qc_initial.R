# ------------------------------------------------------------------------------
# Plots: Quality control for initial data
# TS O'Leary
# ------------------------------------------------------------------------------
...
# Output fig dir
fig_dir <- "output/figs/qc/initial"
...
# Save knee plot
ggsave(here::here(fig_dir, "knee_plots.pdf"),
       height = 15,
       width = 15,
       units = "cm")
ggsave(here::here(fig_dir, "knee_plots.png"),
       height = 15,
       width = 15,
       units = "cm")
...
# Save scatter plot
ggsave(here::here(fig_dir, "scatter_rna_atac_all_barcodes.pdf"),
       height = 20,
       width = 20,
       units = "cm")
ggsave(here::here(fig_dir, "scatter_rna_atac_all_barcodes.png"),
       height = 20,
       width = 20,
       units = "cm")
...
# Save scatter plot
ggsave(here::here(fig_dir, "scatter_rna_atac_10x_cells.pdf"),
       height = 20,
       width = 20,
       units = "cm")
ggsave(here::here(fig_dir, "scatter_rna_atac_10x_cells.png"),
       height = 20,
       width = 20,
       units = "cm")
...
# Save scatter plot
ggsave(here::here(fig_dir, "scatter_rna_atac_cells_threshold.pdf"),
       height = 20,
       width = 20,
       units = "cm")
ggsave(here::here(fig_dir, "scatter_rna_atac_cells_threshold.png"),
       height = 20,
       width = 20,
       units = "cm")
...
# Save plot
ggsave(here::here(fig_dir, "violin_qc_metrics.pdf"),
       height = 15,
       width = 30,
       units = "cm")
ggsave(here::here(fig_dir, "violin_qc_metrics.png"),
       height = 15,
       width = 30,
       units = "cm")