...
# Save two sizes
ggsave("output/figs/cantonS_survival.tiff", height = 4, width = 6)
ggsave("output/figs/cantonS_survival_small.tiff", height = 3.5, width = 5)
```
...
# Save figure
ggsave("output/figs/na_genotypes_survival.tiff", height = 6, width = 10)
```
...
# Save figure
ggsave("output/figs/new_genotypes_survival.tiff", height = 6, width = 8)
```
...
# Save figure
ggsave("output/figs/new_genotypes_egg_to_pupa.tiff", height = 6, width = 8)
```
...
# Save figure
ggsave("output/figs/new_genotypes_egg_to_adult.tiff", height = 6, width = 8)
```
...
# Save figure
ggsave("output/figs/new_genotypes_pupation_height.tiff", height = 6, width = 8)
```
...
# Save figure
ggsave("output/figs/new_genotypes_walking_speed.tiff", height = 6, width = 8)
```
